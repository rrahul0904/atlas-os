...
export function renderIndex():string{const verticalCards=(Object.keys(builders) as DemoId[]).map(id=>`<a href="/demo/${id}"><b>${id.toUpperCase()} OS</b><span>Open demo →</span></a>`).join("");const cards=`<a href="/demo/kernel"><b>HORIZONTAL KERNEL</b><span>See shared business primitives →</span></a>`+verticalCards;return `<!doctype html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>AtlasOS</title><link rel="stylesheet" href="/assets/atlas.css"></head><body class="landing"><main><small class="eyebrow">ATLAS OS</small><h1>Run the business, not the software stack.</h1><p>Observe → Understand → Decide → Act → Automate → Learn.</p><div class="demo-grid">${cards}</div></main></body></html>`}
