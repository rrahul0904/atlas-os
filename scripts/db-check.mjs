...
try{
  ...
  if(Number(migrations[0]?.count)!==4) throw new Error(`Expected 4 migrations, found ${migrations[0]?.count ?? 0}`);
  console.log(`Database contract OK: ${required.length} tables, 4 migrations.`);
}finally{
