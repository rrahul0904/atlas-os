...
export function registerAtlasModules(){
  ...
  defineModule({id:"growth",name:"Growth Intelligence",state:"legacy",sourceRepository:"rrahul0904/tractionmesh",description:"Growth Brain, campaigns, opportunities and attribution",permissions:["growth:read","growth:write"],eventTypes:["campaign.created","conversion.attributed"]});
  defineModule({id:"social",name:"Social Operations",state:"legacy",sourceRepository:"rrahul0904/social-growth-os",description:"Content planning, approval, publishing and closed-loop measurement",permissions:["social:read","social:write"],eventTypes:["content.approved","content.published"]});
  defineModule({id:"launch",name:"Launch & Distribution",state:"legacy",sourceRepository:"rrahul0904/launchgrid",description:"Launch windows, outreach, distribution and analytics",permissions:["launch:read","launch:write"],eventTypes:["launch.started","submission.completed"]});
  defineModule({id:"outbound",name:"Outbound Infrastructure",state:"legacy",sourceRepository:"rrahul0904/outbound-infrastructure-os",description:"Domains, sender health, verification, reputation and delivery",permissions:["outbound:read","outbound:write"],eventTypes:["sender.degraded","reply.received"]});
  defineModule({id:"browser-runtime",name:"Browser Runtime",state:"legacy",sourceRepository:"rrahul0904/sessiongrid",description:"Authorized browser workspaces, policy-aware sessions and audit",permissions:["browser:read","browser:execute"],eventTypes:["session.started","session.stopped"]});
  defineModule({id:"saas-foundation",name:"SaaS Foundation",state:"legacy",sourceRepository:"rrahul0904/vibe-saas-foundry",description:"Reference auth, admin, task and app-shell patterns",permissions:["platform:read"],eventTypes:[]});
}
